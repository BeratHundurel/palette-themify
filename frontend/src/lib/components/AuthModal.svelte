					...
					<div class="mt-4">
						...
						<div class="mt-4 space-y-3">
							<button
								...
								disabled={loading}
								class="flex w-full cursor-pointer items-center justify-center rounded-md border border-zinc-600 bg-zinc-800 py-3 font-medium text-zinc-300 transition-[background-color,border-color] hover:border-zinc-500 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
							>
								{#if loadingType === 'google'}
									<svg
										class="mr-3 -ml-1 h-5 w-5 animate-spin text-zinc-300"
										xmlns="http://www.w3.org/2000/svg"
										fill="none"
