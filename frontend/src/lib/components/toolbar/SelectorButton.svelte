...
<button
	class={cn(
		'group relative transition-[transform,box-shadow,border-color] duration-300 ease-out',
		'h-9 w-9 overflow-hidden rounded-md',
		selector.selected
...
>
	...
	{#if selector.selected}
		<div class="relative z-10 flex h-full w-full items-center justify-center">
			<div class="rounded-full bg-zinc-900/60 p-1 shadow-lg ring-1 ring-white/20">
	...
	<div
		class={cn(
			...
			'border bg-zinc-900 text-[10px] font-semibold shadow-md transition-[border-color,color] duration-300',
			selector.selected
